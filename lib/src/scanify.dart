...
/// Using [ScanifyScanner] may using every feature of this Package

class ScanifyScanner extends StatefulWidget {
  ...
  @override
  State<ScanifyScanner> createState() => _ScanifyScannerState();
}

class _ScanifyScannerState extends State<ScanifyScanner> {
  @override
  void initState() {
